...
class LatestTimelines extends PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const {
            classes,
            timeline: {
                title, description, createdAt, imageUrl, likeCount, timelineId, commentCount, userImage,
                ratingAverage, userHandle, viewsCount
            },
            user: {
                authenticated,
                credentials: {
...
export default connect(
    mapStateToProps
)(withStyles(styles)(LatestTimelines));